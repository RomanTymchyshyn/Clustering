...
/* Другий параметр і все, що його стосується потрібне для малювання, тобто, якщо малювати не потрібно, то можна просто це повидаляти, або ж не передавати 
 * у функцію нічого, тоді буде використано параметр по замовчуванню
 */
